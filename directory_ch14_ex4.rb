# Note for CH14 EX3
# Renamed a few method names to be more suggestive
# Method input_students is a very large method. Can be further refactored
# E.g. the validation of cohort input can be dealt with in a separate method
...
def save_students_to_file
  ...
  file.close
  puts "Student records successfuly saved to file"
end
...
def load_students_from_file(filename = "students.csv")
  ...
  file.close
  puts "List of student records successfuly retrieved from file"
end
